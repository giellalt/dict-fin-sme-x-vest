# Dictionary for fin — sme

This repository contains source files for a dictionary from Finnish to North Sámi. The content is licensed under the CC-BY-4.0 license.
